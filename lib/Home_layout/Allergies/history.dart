      ...
      body: SingleChildScrollView(
        ...
        child: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Does any of the family members have medical issues?',
              style: TextStyle(
                fontSize: 23,
            ...
            children: [
              ...
              Center(
                child: Container(width: 150,
                  ...
                  child: MaterialButton(child: Text('Save',
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 30
                  ),),
