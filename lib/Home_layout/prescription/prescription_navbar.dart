...
import 'package:grad_project/Home_layout/prescription/prescription_form/prescription_form.dart';
...
class Prescreption_navbar extends StatefulWidget {
  ...
  static const String routeName = 'Prescreption_navbar';
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: BottomNavigationBar(
          ...
          items: [
            ...
            BottomNavigationBarItem(
                icon: Icon(Icons.person, size: 30), label: 'Prescription Form'),
